...
const le = st(
  ...
  me =
    (nt(["click"]),
    st('<span> <a href="javascript:void(0)"  id="lite-badge"><span> ')),
  ve = "#303235",
  we = (t) => {
    let e, r;
    const s = (r) => {
...
const qr = (t) => {
  ...
  Hr = "¡Hola! ¿En qué puedo ayudarte hoy?",
  Wr = (t) => {
    let e, r, s;
    const [n, o] = x(""),
      [i, a] = x(!1),
  ...
  Zr = (t) => {
    var e = t.id
      ...
      : document.querySelector("onbotgo-fullchatbot");
    if (!e) throw new Error("<onbotgo-fullchatbot> element not found.");
    Object.assign(e, t);
  },
  ts = (t) => {
    var e = document.createElement("onbotgo-chatbot");
    Object.assign(e, t), document.body.appendChild(e);
  },
  es =
    ("undefined" != typeof window &&
      (mt("onbotgo-fullchatbot", vt, Qr), mt("onbotgo-chatbot", vt, Xr)),
    { initFull: Zr, init: ts });
((t) => {
